...
object GlobalState {
    ...
    const val NOTIFICATION_CHANNEL = "FlClashR"
    const val SUBSCRIPTION_NOTIFICATION_CHANNEL = "FlClashR_Subscription"
    ...
    fun hasActiveProfile(): Boolean {
        val prefs = FlClashRApplication.getAppContext()
    ...
    fun initServiceEngine() {
        ...
        runLock.withLock {
            ...
            serviceEngine = FlutterEngine(FlClashRApplication.getAppContext())
